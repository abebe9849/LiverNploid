...
def train_fn(CFG,fold,folds,test_pl=0):
    ...
    valid_dataset = TrainDataset_(val_folds,train=True,transform1=get_transforms(data='valid',CFG=CFG),CFG=CFG)#
...
def submit(CFG,test):
    ...
    for fold in   range(5):
        ...
        #model.load_state_dict(torch.load(f"/home/abebe9849/Nploid/src/outputs/2023-03-12/21-30-19/fold{i}_b0_aug_gray_best_AUC.pth", map_location="cpu"))
