...
def submit(CFG,test):
    ...
    for i in   range(5):
        ...
        model.load_state_dict(torch.load(f"/home/abebe9849/Nploid/src/outputs/2022-12-23/efnetv2S/fold{i}_nosiy__best_AUC.pth", map_location="cpu"))
        models.append(model)
...
csvs = glob.glob("/data/RSNA/TGCAliver/csvs_/*csv")
...
@hydra.main(config_path="/home/abebe9849/Nploid/src/outputs/B0/08-11-10/.hydra/",config_name="config")
def main(CFG : DictConfig) -> None:
    ...
    df = pd.read_csv("/data/RSNA/TGCAliver/csvs_/60ee612c-660b-4d20-ba27-31f8ba43717a.csv")
    df = pd.read_csv("/data/RSNA/TGCAliver/csvs_/bc3322bd-afeb-4644-81c4-b67a38aea369.csv")
